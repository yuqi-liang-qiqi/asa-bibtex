...
% Example usage for biblatex-asa:
% 1. If you installed biblatex-asa system-wide or copied biblatex-asa.sty, asa.bbx, and asa.cbx to your project directory, simply use:
\usepackage{biblatex-asa}
% 2. If you are developing locally, generate the style files from src/literate-programming/ using:
%    latex biblatex-asa.ins
%    and copy the resulting files to your project directory.
\addbibresource{example-without-package.bib}
...
% Citing an in-text example with e.g.
